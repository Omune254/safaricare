...
import 'package:safaricare/serviceFrom/Mpesa_Payment.dart'; // Import your M-Pesa payment screen class

// PSV Operator Registration Widget
class PsvOperator extends StatelessWidget {
  const PsvOperator({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'PSV Operator Registration',
          style: TextStyle(color: Colors.white),
        ),
      ),
      body: const PsvOperatorForm(),
    );
  }
}

// PSV Operator Form Widget
class PsvOperatorForm extends StatefulWidget {
  const PsvOperatorForm({super.key});

  @override
  PsvOperatorFormState createState() {
    return PsvOperatorFormState();
  }
}

// State for PSV Operator Form
class PsvOperatorFormState extends State<PsvOperatorForm> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (paymentSuccessful) {
        ...
        try {
          ...
          // Create a new PSV operator instance
          PsvOperatorModel psvOperator = PsvOperatorModel(
            fullName: _fullName,
  ...
  Future<String> _uploadImageToStorage(XFile image) async {
    try {
      ...
      Reference storageReference =
          FirebaseStorage.instance.ref().child('psv_operator_images/$fileName');
